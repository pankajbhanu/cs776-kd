...
from ..config.utils import MODULE2PACKAGE
...
class Registry:
    ...
    https://..readthedocs.io/en/latest/advanced_tutorials/registry.html.
    """
    ...
    def switch_scope_and_registry(self, scope: Optional[str]) -> Generator:
        ...
        Examples:
            >>> from ..registry import Registry, DefaultScope, MODELS
            >>> import time
            >>> # External Registry
    ...
    def get(self, key: str) -> Optional[Type]:
        ...
        information, for example, `..model.BaseModel`, ``get``
        ...
        if obj_cls is None:
            ...
            # `dict(type='..model.BaseModel')`, which can
