        ...
        if isinstance(obj_type, str):
            ...
            if obj_cls is None:
                raise KeyError(
                    ...
                    'can be found at '
                    'https://..readthedocs.io/en/latest/advanced_tutorials/config.html#import-the-custom-module'  # noqa: E501
                )
...
def build_runner_from_cfg(cfg: Union[dict, ConfigDict, Config],
    ...
    assert isinstance(
        registry, Registry), ('registry should be a ..Registry object',
                              f'but got {type(registry)}')
        ...
        if isinstance(obj_type, str):
            ...
            if runner_cls is None:
                raise KeyError(
                    ...
                    f'Please check whether the value of `{obj_type}` is '
                    'correct or it was registered as expected. More details '
                    'can be found at https://..readthedocs.io/en/latest/advanced_tutorials/config.html#import-the-custom-module'  # noqa: E501
                )
            ...
            if isinstance(scheduler_type, str):
                ...
                if scheduler_cls is None:
                    raise KeyError(
                        ...
                        'as expected. More details can be found at https://..readthedocs.io/en/latest/advanced_tutorials/config.html#import-the-custom-module'  # noqa: E501
                    )
