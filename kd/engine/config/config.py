...
class Config:
    ...
    .. _config tutorial: https://..readthedocs.io/en/latest/advanced_tutorials/config.html
    """  # noqa: E501
        ...
        for idx, node in enumerate(nodes):
            if (isinstance(node, ast.Assign)
                ...
                raise ConfigParsingError(
                    ...
                    'in https://..readthedocs.io/en/latest/advanced_tutorials/config.html'  # noqa: E501
                )
    ...
    def _file2dict(
        ...
        if lazy_import is None and Config._is_lazy_import(filename):
            raise RuntimeError(
                ...
                'information in https://..readthedocs.io/en/latest/advanced_tutorials/config.html'  # noqa: E501
            )
...
def read_base():
    ...
    .. _tutorial: https://..readthedocs.io/en/latest/advanced_tutorials/config.html#a-pure-python-style-configuration-file-beta
    """  # noqa: E501
    yield
