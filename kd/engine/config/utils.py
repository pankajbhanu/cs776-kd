...
class ImportTransformer(ast.NodeTransformer):
    ...
    :class:`..config.LazyObject` and preload the base variable before
    ...
    To avoid this problem, we introduce :class:`..config.LazyObject` and
    :class:`..config.LazyAttr`. Before we proceed with further
    ...
    def visit_ImportFrom(
        ...
        for alias_node in node.names:
            ...
            if alias_node.name == '*':
                ...
                # case1:
                # from ..dataset import BaseDataset as Dataset ->
                # Dataset = LazyObject('..dataset', 'BaseDataset')
                ...
                # BaseModel = LazyObject('..model', 'BaseModel')
