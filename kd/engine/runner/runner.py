...
from ..dataset import worker_init_fn as default_worker_init_fn
from ..device import get_device
from ..dist import (broadcast, get_dist_info, get_rank, get_world_size,
...
class Runner:
    ...
    def build_param_scheduler(
        ...
        Examples:
            ...
            >>> schedulers
            [<..optim.scheduler.lr_scheduler.MultiStepLR at 0x7f70f6966290>]  # noqa: E501
            ...
            >>> schedulers = runner.build_param_scheduler(scheduler_cfg)
            >>> schedulers
            [<..optim.scheduler.lr_scheduler.MultiStepLR at 0x7f70f60dd3d0>,  # noqa: E501
            <..optim.scheduler.lr_scheduler.StepLR at 0x7f70f6eb6150>]
        ...
        .. _optimizer-docs:
           https://..readthedocs.io/en/latest/tutorials/optim_wrapper.html
        """
    ...
    def save_checkpoint(
        ...
        Args:
            ...
            file_client_args (dict, optional): Arguments to instantiate a
                FileClient. See :class:`..fileio.FileClient` for
